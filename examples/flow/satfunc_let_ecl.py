"""Make three-phase rel.perm tables with LET correlations and write in Eclipse format

LET coefficients from Excel spreadsheet
...
# Excel file with LET coefficients
excel_file = r'C:\Users\torb\MyData\python\roxar_api_utils\roxar_api_utils\examples\flow\x_let.xlsx'
